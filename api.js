    ...
    initializeData() {
        ...
        this.attractionsData = [
                ...
                reviews: [
                    {
                        author: 'สมชาย ใจดี',
                        rating: 5,
                        comment: 'วิวสวยมาก! ขึ้นไปแล้วเห็นทิวทัศน์ 360 องศา คุ้มค่าการเดินทางมาก ควรมาช่วงเช้าหรือเย็นจะสวยกว่า',
                        date: '2 สัปดาห์ที่แล้ว'
                    },
                    {
                        author: 'มาลี รักเที่ยว',
                        rating: 5,
                        comment: 'สถานที่ท่องเที่ยวที่ต้องมาเมื่อมาบึงกาฬ! สะพานไม้สวยงาม เดินขึ้นไปไม่เหนื่อยมาก แนะนำเลย',
                        date: '1 เดือนที่แล้ว'
                    },
                    {
                        author: 'ธนา ผจญภัย',
                        rating: 4,
                        comment: 'ภูเขาหินปูนที่สวยงาม แต่ช่วงที่ไปแดดแรงมาก ควรเตรียมหมวกและน้ำไปด้วย',
            ...
            },
            {
                ...
                reviews: [
                    {
                        author: 'ปิยะ ธรรมชาติ',
                        rating: 4,
                        comment: 'น้ำตกสวยมาก น้ำใสเซาะ บรรยากาศป่าดงดิบร่มรื่น เดินทางไม่ยากมาก แต่ควรใส่รองเท้าที่เหมาะสม',
                        date: '1 สัปดาห์ที่แล้ว'
                    },
                    {
                        author: 'สมศักดิ์ ผจญภัย',
                        rating: 4,
                        comment: 'ธรรมชาติสวยงาม เสียงน้ำตกเพราะมาก อากาศเย็นสบาย เหมาะสำหรับการพักผ่อนหย่อนใจ',
                        date: '2 สัปดาห์ที่แล้ว'
                    }
                ]
            },
            {
                ...
                reviews: [
                    {
                        author: 'สุรชัย นักดูนก',
                        rating: 4,
                        comment: 'สถานที่ดูนกที่ยอดเยี่ยม! เห็นนกหลายชนิดมาก โดยเฉพาะช่วงเช้าตรู่ บรรยากาศสงบ เหมาะสำหรับคนรักธรรมชาติ',
                        date: '2 สัปดาห์ที่แล้ว'
                    },
                    {
                        author: 'มาลัย ธรรมชาติ',
                        rating: 4,
                        comment: 'ทะเลสาบใหญ่สวยงาม อากาศดี เห็นนกน้ำเยอะมาก ควรเตรียมกล้องส่องทางไกลมาด้วย',
                        date: '1 เดือนที่แล้ว'
                    }
                ]
            },
                ...
                reviews: [
                    {
                        author: 'วิทยา ศรัดธา',
                        rating: 5,
                        comment: 'สถานที่ศักดิ์สิทธิ์มาก! หินรูปร่างคล้ายพญานาคจริงๆ บรรยากาศสงบ เหมาะสำหรับการสักการะ ต้องเดินขึ้นไปสักหน่อย',
                        date: '1 สัปดาห์ที่แล้ว'
                    },
                    {
                        author: 'กมล ธรรมชาติ',
                        rating: 5,
                        comment: 'ถ้ำสวยงามมาก มีความเชื่อเรื่องพญานาคที่น่าสนใจ ควรมาช่วงเช้าจะไม่ร้อนมาก',
                        date: '2 สัปดาห์ที่แล้ว'
                    }
                ]
            },
                ...
                reviews: [
                    {
                        author: 'สมพร ศรัดธา',
                        rating: 4,
                        comment: 'วัดสวยงาม บรรยากาศสงบ วิวแม่น้ำโขงสวยมาก เป็นจุดสะดือแม่น้ำโขงตามความเชื่อ เหมาะสำหรับการสักการะ',
                        date: '1 สัปดาห์ที่แล้ว'
                    },
                    {
                        author: 'ธีรพงษ์ ท่องเที่ยว',
                        rating: 4,
                        comment: 'สถานที่ศักดิ์สิทธิ์ริมโขง บรรยากาศดี เหมาะสำหรับการทำบุญ ชมพระอาทิตย์ขึ้นและตกดิน',
                        date: '2 สัปดาห์ที่แล้ว'
                    }
                ]
            },
        ...
        this.cafesData = [
            {
                ...
                reviews: [
                    {
                        author: 'นิรันดร์ ชมวิว',
                        rating: 4,
                        comment: 'วิวแม่น้ำโขงสวยมาก! นั่งชิลดูพระอาทิตย์ตกดิน กาแฟรสชาติดี อาหารก็อร่อย แนะนำมาช่วงเย็นๆ',
                        date: '1 สัปดาห์ที่แล้ว'
                    },
                    {
                        author: 'สุดา คาเฟ่เลิฟเวอร์',
                        rating: 4,
                        comment: 'บรรยากาศดีมาก ริมโขงจริงๆ ราคาไม่แพง พนักงานบริการดี มีที่จอดรถสะดวก',
                        date: '2 สัปดาห์ที่แล้ว'
                    }
                ]
            },
            {
                ...
                reviews: [
                    {
                        author: 'มณีรัตน์ คาเฟ่ฮอป',
                        rating: 4,
                        comment: 'บรรยากาศอบอุ่นมาก ตกแต่งสวยงาม มีมุมถ่ายรูปเยอะ เค้กช็อกโกแลตอร่อยมาก กาแฟก็หอมดี',
                        date: '4 วันที่แล้ว'
                    },
                    {
                        author: 'อรุณ ชิลล์เลอร์',
                        rating: 4,
                        comment: 'ร้านน่ารักมาก เจ้าของใจดี บริการดี ราคาไม่แพง นั่งทำงานได้สบายๆ',
                        date: '1 สัปดาห์ที่แล้ว'
                    }
                ]
            },
        ...
        this.accommodationsData = [
            {
                ...
                reviews: [
                    {
                        author: 'จิรายุ นักเดินทาง',
                        rating: 4,
                        comment: 'โรงแรมดีมาก ห้องพักสะอาด สิ่งอำนวยความสะดวกครบ พนักงานบริการดี ที่จอดรถกว้าง',
                        date: '3 วันที่แล้ว'
                    },
                    {
                        author: 'สมหญิง พักผ่อน',
                        rating: 4,
                        comment: 'ตั้งอยู่ในตัวเมือง เดินทางสะดวก ห้องพักกว้างขวาง เตียงนอนสบาย อาหารเช้าหลากหลาย',
                        date: '1 สัปดาห์ที่แล้ว'
                    }
                ]
            },
        ...
        this.restaurantsData = [
            {
                ...
                reviews: [
                    {
                        author: 'วิชัย กินเก่ง',
                        rating: 4,
                        comment: 'อาหารอร่อยมาก โดยเฉพาะปลาแม่น้ำย่าง สดใหม่ดี วิวริมโขงสวย ราคาเหมาะสม',
                        date: '5 วันที่แล้ว'
                    },
                    {
                        author: 'แสงดาว ท่องเที่ยว',
                        rating: 5,
                        comment: 'ร้านนี้ดีมาก! อาหารอีสานแท้ๆ รสชาติจัดจ้าน ส้มตำปูปลาร้าเด็ดมาก บรรยากาศริมน้ำโรแมนติก',
                        date: '1 สัปดาห์ที่แล้ว'
                    },
                    {
                        author: 'ประยุทธ์ รีวิวเวอร์',
                        rating: 4,
                        comment: 'มาทานอาหารเย็นพร้อมชมพระอาทิตย์ตก บรรยากาศดีมาก อาหารรสชาติดี แต่บางเมนูรอนานหน่อย',
                        date: '2 สัปดาห์ที่แล้ว'
                    }
                ]
            },
